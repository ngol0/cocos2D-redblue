        ...
        onLoad() {
          ...
          for (let i = 0; i < this.amountOfEnemyToPool; i++) {
            ...
            this._arrayOfEnemies.forEach(element => {
              let enemyComponent = element.getComponent(_crd && Enemy === void 0 ? (_reportPossibleCrUseOfEnemy({
                error: Error()
              }), Enemy) : Enemy);
          ...
          for (let k = 0; k < this.amountOfBullet; k++) {
            ...
            let bulletComponent = bullet.getComponent(_crd && Bullet === void 0 ? (_reportPossibleCrUseOfBullet({
              error: Error()
            }), Bullet) : Bullet);
          ...
          for (let n = 0; n < this.amountOfPlayerEnim; n++) {
            ...
            let playerComponent = player.getComponent(_crd && Enemy === void 0 ? (_reportPossibleCrUseOfEnemy({
              error: Error()
            }), Enemy) : Enemy);
          ...
          this._arrayOfIconObjects.forEach(element => {
            let iconComponent = element.getComponent(_crd && Icons === void 0 ? (_reportPossibleCrUseOfIcons({
              error: Error()
            }), Icons) : Icons);
          ...
          let bombComponent = bombicon.getComponent(_crd && BombIcon === void 0 ? (_reportPossibleCrUseOfBombIcon({
            error: Error()
          }), BombIcon) : BombIcon);
          ...
          for (let l = 0; l < this.amountOfBullet; l++) {
            ...
            let bossBulletComp = bossBullet.getComponent(_crd && BossBullet === void 0 ? (_reportPossibleCrUseOfBossBullet({
              error: Error()
