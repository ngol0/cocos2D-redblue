      ...
      _export("Spawner", Spawner = (_dec = ccclass('Spawner'), _dec2 = property({
        ...
        generateItemsByRow() {
          ...
          if (!this.bossSpawning) {
            ...
            for (var i = 2; i < this.rowLength; i++) {
              this._row.push(Math.floor(Math.random() * 3));
            } //0 to 2
            ...
            for (var _i = 1; _i < this.rowLength; _i++) {
        ...
        spawnItems() {
          for (var j = 0; j < this._row.length; j++) {
            var item = this.spawnByItemType(this._row[j]); //spawning items
