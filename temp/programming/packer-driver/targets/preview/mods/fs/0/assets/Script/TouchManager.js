System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, _decorator, Component, Node, GameManager, Player, _dec, _dec2, _class, _class2, _descriptor, _descriptor2, _temp, _crd, ccclass, property, TouchManager;
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "bcb12pd2i1NPZb2sKwXthyB", "TouchManager", undefined);
      ...
      _export("TouchManager", TouchManager = (_dec = ccclass('TouchManager'), _dec2 = property({
        type: _crd && Player === void 0 ? (_reportPossibleCrUseOfPlayer({
          error: Error()
        }), Player) : Player
      }), _dec(_class = (_class2 = (_temp = class TouchManager extends Component {
        constructor() {
          super(...arguments);
        ...
        start() {
          this.node.on(Node.EventType.TOUCH_START, event => {
            this.player.getComponent(_crd && Player === void 0 ? (_reportPossibleCrUseOfPlayer({
              error: Error()
            }), Player) : Player).Move(this.direction); //GameManager.Instance.AddScore();

            if ((_crd && GameManager === void 0 ? (_reportPossibleCrUseOfGameManager({
              error: Error()
            }), GameManager) : GameManager).Instance.AddScore() >= 10) {
              this.player.getComponent(_crd && Player === void 0 ? (_reportPossibleCrUseOfPlayer({
                error: Error()
